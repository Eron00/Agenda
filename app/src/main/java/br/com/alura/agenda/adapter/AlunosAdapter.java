...
public class AlunosAdapter extends BaseAdapter {
    ...
    //devolve o aluno pela posição da lista( de 0 ate....)
    @Override
    public Object getItem(int position) {
        return alunos.get(position);
    }

    //devolve o aluno solicitado, pelo id registrado no banco
    @Override
    public long getItemId(int position) {
        return alunos.get(position).getId();
    }

    //devolve a view com a informação do aluno, respeitando a sua posição na lista
    @Override
